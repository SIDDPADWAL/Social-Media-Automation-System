...
if($newpass===$confpass)
{
  $sql="SELECT eupass FROM end_user WHERE eupass='$currpass' and euid='$euid' and eustatus!=0";
 $result = $conn->query($sql);
  if ($result->num_rows > 0){
    $sqlupdate = "UPDATE end_user SET eupass='$newpass' WHERE eupass='$currpass' and euid='$euid' and eustatus!=0";
